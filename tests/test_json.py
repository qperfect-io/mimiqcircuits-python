...
def test_allgates():
    ...
    for gatetype in params_1q_3p:
        for n in range(0, 8):
            c.push(gatetype(*[random.random() for r in range(0, 3)]), n)

    for gatetype in params_1q_2p:
        for n in range(0, 8):
            c.push(gatetype(*[random.random() for r in range(0, 2)]), n)

    for gatetype in params_1q_1p:
        for n in range(0, 8):
            c.push(gatetype(random.random()), n)
    ...
    for gatetype in params_2q_4p:
        for n in [(0, 7), (0, 3), (2, 4), (7, 1), (7, 0), (4, 2)]:
            c.push(gatetype(*[random.random() for r in range(0, 4)]), *n)
